...
g++ -DDEBUG -m64 -Wall -fPIC -L/usr/lib64/mysql -I/usr/local/include/mysql -O -pipe -o lib/mysqldamlevlim256u64.so -shared -L/usr/local/lib64/mysql -I/usr/include/mysql -lmysqlclient src/damlevlim256u.cpp
